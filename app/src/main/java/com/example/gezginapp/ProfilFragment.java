...
public class ProfilFragment extends Fragment {
    ...
    {
        Uri instauri = Uri.parse("https://www.instagram.com/gezi_rehberi/");
        Intent i = new Intent(Intent.ACTION_VIEW,instauri);
        ...
        {
            startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.instagram.com/gezi_rehberi/")));
        }
    }
